...
def obtener_palabra_secreta() -> str:
    palabras = ['python', 'javascript', 'java', 'angular', 'django', 'tensorflow', 'react']
...
def juego_ahorcado():
    ...
    print(f"Tienes {intentos} intentos para adivinar la palbra secreta")
    ...
    while not juego_terminado and intentos > 0:
        ...
        if len(adivinanza) != 1 or not adivinanza.isalpha():
            ...
            print("Ya has utilizado esa letera, prueba con otra")
        else:
            ...
            if adivinanza in palabra_secreta:
                ...
                intentos -=1
                print(f"Lo siento la letra '{adivinanza}' no está presente en la palabra")
        ...
        if "_" not in progreso_actual:
            ...
            print(f"!Felicitaciones has ganaso¡ La palabra completa es: '{palabra_secreta}'")

    if intentos == 0:
        palabra_secreta = palabra_secreta.capitalize()
        print(f"Lo sentimos mucho se te hann acabado los intentos, la palabra secreta era '{palabra_secreta}'")
